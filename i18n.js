...
(function(){
  ...
  const DICT = {
    en: {
      ...
      'cost.settleStyle':'Style','cost.settleGrouped':'Grouped','cost.settleMinimal':'Fewest','cost.groupedNote':'Everyone pays','cost.groupedNote2':'who then settles with the other payers.',
    ...
    fr: {
      ...
      'cost.settleStyle':'Style','cost.settleGrouped':'Groupé','cost.settleMinimal':'Minimal','cost.groupedNote':'Tout le monde paie','cost.groupedNote2':'qui règle ensuite avec les autres payeurs.',
