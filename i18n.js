...
(function(){
  ...
  const DICT = {
    en: {
      ...
      'it.removePoint':'Remove','it.hidePoint':'Hide','it.needTitle':'Give the point a title','it.pointAdded':'Timeline point added — sorted into place','it.confirmHide':'Hide this default timeline point?',
      ...
      'meal.edit':'Edit this meal','meal.editPrompt':'Edit items (one per line):','meal.updated':'Meal updated',
    ...
    fr: {
      ...
      'it.removePoint':'Retirer','it.hidePoint':'Masquer','it.needTitle':'Donne un titre au point','it.pointAdded':'Point ajouté — trié au bon endroit','it.confirmHide':'Masquer ce point par défaut de la chronologie?',
      ...
      'meal.edit':'Modifier ce repas','meal.editPrompt':'Modifier les items (un par ligne) :','meal.updated':'Repas mis à jour',
